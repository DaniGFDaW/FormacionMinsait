...
public class Main {
	...
	//Ejercicio 3. Pedir tres números y mostrarlos ordenados de mayor a menor
	...
	//Ejercicio 5. Pedir dos fechas y mostrar el número de días que hay de diferencia. Suponiendo todos los meses de 30 días
	...
	public static void ejr5() {
		...
		System.out.println("Hay una diferencia de "+ (fecha2-fecha1) + " días.");
	}
	...
	//Ejercicio 8. Pide un número (que debe estar entre 0 y 10) y mostrar la tabla de multiplicar de dicho número.
	...
	//Ejercicio 9. Realiza detenidamente una traza al siguiente programa y muestra cual sería la salida por pantalla:
	...
	correctas ingresar el menú que tenga la posibilidad de modificar la clave mostrando un mensaje “Clave cambiada con éxito”*/
	...
	//Ejercicio 11. ¿Cuántas veces se imprimirá el siguiente código “Hola Mundo”?
